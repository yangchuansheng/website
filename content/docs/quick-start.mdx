...
![Sealos Devbox 创建 Next.js 项目界面，显示框架选择和资源配置选项](./images/devbox-nextjs-framework.png)

<h4>配置网络设置</h4>

![Sealos Devbox 网络配置界面，展示端口设置和域名配置选项](./images/devbox-nextjs-network.png)
...
![Sealos Devbox 项目列表操作界面，展示包含 Cursor IDE 和 VSCode 等开发工具选项](./images/devbox-list-operation.png)
...
![Cursor IDE 远程开发界面，展示连接到 Sealos Devbox 的项目文件结构](./images/cursor-remote-devbox.png)
...
- 点击地址栏右侧的 🌐 按钮。
   ![Sealos Devbox 网络面板中的应用访问按钮界面](./images/devbox-nextjs-network-open.png)
- 在弹窗中选择 "Open"，即可在浏览器中打开并测试运行中的应用。

  ![运行在 Sealos Devbox 上的 Next.js 示例应用预览界面](./images/devbox-nextjs-demo.jpg)
...
![Sealos Devbox OCI 镜像发布界面，包含版本和描述信息填写选项](./images/devbox-release-oci-image.png)
...
![Sealos Devbox 版本列表界面，显示已发布的应用版本信息](./images/devbox-release-version-lists.png)
...
![Sealos Devbox 应用部署配置界面，展示资源和环境设置选项](./images/devbox-release-deploy.png)
...
![Sealos Devbox 应用部署成功界面，显示运行状态和访问地址](./images/devbox-release-deploy-success.png)
...
![Sealos Devbox 更新应用](./images/devbox-release-deploy-update.png)
</Callout>
