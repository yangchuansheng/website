...
![Sealos 对象存储](./images/sealos-objectstorage.png)

在对象存储应用界面中，点击【创建存储桶】按钮，输入存储桶名称，设置存储桶的访问权限，然后点击右上角的【应用】按钮。

![Sealos 对象存储控制台创建存储桶操作界面](./images/object-storage-create-bucket-interface.png)
...
![Sealos 对象存储上传文件操作界面](./images/object-storage-upload-file-interface.png)
...
![Sealos 存储桶权限设置入口](./images/sealos-bucket-permission-setting-entry.png)
...
![Sealos 对象存储访问密钥获取入口](./images/sealos-objectstorage-access-key-get-entry.png)
...
![Sealos 对象存储访问密钥获取结果](./images/sealos-objectstorage-access-key-get-result.png)
...
![启用 Sealos 对象存储静态托管功能](./images/sealos-objectstorage-static-hosting-enable.png)
...
![查看静态网站访问地址](./images/sealos-objectstorage-static-hosting-access.png)
...
![Sealos 对象存储自定义域名配置](./images/sealos-objectstorage-static-hosting-custom-domain.png)
