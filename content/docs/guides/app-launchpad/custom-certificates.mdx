...
![Sealos 创建 TLS Secret 界面](./images/sealos-create-tls-secret.png)
...
![Sealos 修改 Ingress 配置界面](./images/sealos-patch-ingress.png)

</div>

最终您就可以通过自定义域名访问您的应用了。

![Sealos 自定义域名访问界面](./images/sealos-custom-domain.png)
